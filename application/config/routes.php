...
$route['admin/surveys/logic/delete/(:num)/(:num)'] = 'survey_builder/survey_logic/delete/$1/$2';
$route['admin/surveys/logic/get_logics/(:num)'] = 'survey_builder/survey_logic/get_logics/$1';
